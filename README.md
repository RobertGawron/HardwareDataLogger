...
#### STM32F103RBTx Board
The STM32F103RBTx serves as the main microcontroller, handling data acquisition, processing, storage, and user interaction. In future iterations, the STM32F103RBTx will be replaced by an STM32 chip directly integrated onto the PCB.
