...
if(LCOV_PATH AND GENHTML_PATH AND CMAKE_BUILD_TYPE STREQUAL "Debug")
    set(COVERAGE_DIR "${CMAKE_SOURCE_DIR}/DevOps/BuildArtifacts/CppCodeCoverage")
    ...
    add_custom_target(cov
        ...
        COMMAND ${LCOV_PATH} --ignore-errors mismatch --directory ${CMAKE_BINARY_DIR} --capture --output-file ${COVERAGE_DIR}/coverage.info --base-directory ${CMAKE_SOURCE_DIR}
        COMMAND ${LCOV_PATH} --remove ${COVERAGE_DIR}/coverage.info  --output-file ${COVERAGE_DIR}/coverage.filtered.info '*/Test/*' '/usr/*' '/opt/*'
