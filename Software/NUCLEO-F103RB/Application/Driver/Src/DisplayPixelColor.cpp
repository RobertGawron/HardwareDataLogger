...
uint16_t DisplayPixelColor::getColor(uint8_t red, uint8_t green, uint8_t blue) {
 ...
 */
uint16_t DisplayPixelColor::getColorRGB565(uint8_t red, uint8_t green, uint8_t blue) {
...
const uint16_t DisplayPixelColor::BLACK = DisplayPixelColor::getColor(0x00, 0x00, 0x00);
const uint16_t DisplayPixelColor::BLUE = DisplayPixelColor::getColor(0x00, 0x00, 0xFF);
const uint16_t DisplayPixelColor::RED = DisplayPixelColor::getColor(0xFF, 0x00, 0x00);
const uint16_t DisplayPixelColor::GREEN = DisplayPixelColor::getColor(0x00, 0xFF, 0x00);
const uint16_t DisplayPixelColor::CYAN = DisplayPixelColor::getColor(0x00, 0xFF, 0xFF);
const uint16_t DisplayPixelColor::MAGENTA = DisplayPixelColor::getColor(0xFF, 0x00, 0xFF);
const uint16_t DisplayPixelColor::YELLOW = DisplayPixelColor::getColor(0xFF, 0xFF, 0x00);
const uint16_t DisplayPixelColor::WHITE = DisplayPixelColor::getColor(0xFF, 0xFF, 0xFF);
}  // namespace Driver