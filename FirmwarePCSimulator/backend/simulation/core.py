...
from .loggers import UartLogger, SdCardLogger
...
class Simulation:
    ...
    def __init__(self, sdcard_manager):
        # Async / WebSocket
        self.loop = None
        self.sdcard_manager = sdcard_manager
    ...
    def _handle_sd_event(self, event: dict):
