...
public:
    ...
    MOCK_METHOD(void, ST7735_DrawPixel, (std::uint16_t x, std::uint16_t y, std::uint16_t color), ());
    MOCK_METHOD(void, ST7735_WriteString, (std::uint16_t x, std::uint16_t y, const char *str, FontDef font, std::uint16_t color, std::uint16_t bgcolor), ());
    MOCK_METHOD(void, ST7735_FillRectangle, (std::uint16_t x, std::uint16_t y, std::uint16_t w, std::uint16_t h, std::uint16_t color), ());
    MOCK_METHOD(void, ST7735_FillScreen, (std::uint16_t color), ());
    MOCK_METHOD(void, ST7735_DrawImage, (std::uint16_t x, std::uint16_t y, std::uint16_t w, std::uint16_t h, const std::uint16_t *data), ());
