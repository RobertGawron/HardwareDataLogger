...
class ESP8266WiFiClass : Client //: public ESP8266WiFiGenericClass, public ESP8266WiFiSTAClass, public ESP8266WiFiScanClass, public ESP8266WiFiAPClass
{
public:
    // HAAKCK
    void begin(std::string ssid, std::string pass) {}
