...
namespace Driver
{
    ...
    IDisplayDriver::Status St7735DisplayDriverStub::setOrientation(IDisplayDriver::Orientation orientation)
    {
        return IDisplayDriver::Status::Ok;
    }

    IDisplayDriver::Status St7735DisplayDriverStub::getOrientation(IDisplayDriver::Orientation &orientation) const
    {
        return IDisplayDriver::Status::Ok;
    }
